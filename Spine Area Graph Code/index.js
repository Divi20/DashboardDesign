...
var options = ['img', 'name', 'date','amount'];

var list = [{img:"img/img1",name: "Netflix", date:"78", amount:"8$"},
{img:"img/img1",name: "Netflix", date:"78", amount:"8$"},
{img:"img/img1",name: "Netflix", date:"78", amount:"8$"},
{img:"img/img1",name: "Netflix", date:"78", amount:"8$"}];

var parselist = JSON.parse(list);
this.document.getElementById('#img').innerHTML = parsedlist.name;
